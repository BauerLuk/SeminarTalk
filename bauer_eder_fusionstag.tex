...
\author[M.~Eder, L.~Bauer]{\scriptsize Michael Eder, Lukas Bauer \\Group W. Kernbichler (Graz University of Technology)
}
\date{15. November 2019, Fusion@ÖAW, $6^{\text{th}}$ Fusion Day, Salzburg} % \today für heutiges Datum verwenden
%\date{\today}
